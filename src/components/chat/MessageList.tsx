  ...
  if (messages.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] px-4 text-center">
        ...
        <p className="text-neutral-900 font-semibold text-lg mb-2">Inicia una conversación para generar componentes de React</p>
        <p className="text-neutral-500 text-sm max-w-sm">Puedo ayudarte a crear botones, formularios, tarjetas y más</p>
      </div>
    );
  }
